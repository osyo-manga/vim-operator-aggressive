...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_operator_aggressive#Unlocker#Holder#import() abort
  ...
  execute join(['function! vital#_operator_aggressive#Unlocker#Holder#import() abort', printf("return map({'_vital_depends': '', 'as_get_deepcopy': '', 'exists': '', 'as_set_extend': '', 'get': '', 'make': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
